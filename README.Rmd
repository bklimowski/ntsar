...
tsar ([Nonlinear] **T**ime **S**eries **A**nalysis with **R**) is package dedicated to provide tools derived from dynamical system theory for purpose of analysis nonlinear properties of time series. 
Developed version should contain things like:
